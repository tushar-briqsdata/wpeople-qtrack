...
<?php if (isset($tip)): ?>
    <div class="well well col-md-6 col-md-offset-3 text-center">
        <div class="row">
            ...
            <div class="col-xs-12">
                <h3><i class="fa fa-quote-left"></i> <?php echo $view['translator']->trans('mautic.core.noresults.tip'); ?> <i class="fa fa-quote-right"></i></h3>
