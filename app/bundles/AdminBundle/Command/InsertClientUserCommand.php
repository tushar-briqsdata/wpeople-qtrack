...
class InsertClientUserCommand extends ModeratedCommand {

    protected $container;

    protected function configure() {
        $this
                ->setName('mautic:admin:insertclientadmin')
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        try {
            ...
            $user->setRole($entityManager->getReference('MauticUserBundle:Role', 2));
